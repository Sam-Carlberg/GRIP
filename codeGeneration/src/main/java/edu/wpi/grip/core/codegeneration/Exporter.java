...
import edu.wpi.grip.core.codegeneration.data.TPipeline;
...
public class Exporter implements Runnable {
  ...
  public void run() {
    ...
    String templateDir = "/edu/wpi/grip/core/codegeneration/" + lang.filePath;
  ...
  private boolean isExportable(Step step) {
    return Exporter.class.getResource(
        String.format(
            "/edu/wpi/grip/core/codegeneration/%s/operations/%s.vm",
            lang.filePath,
