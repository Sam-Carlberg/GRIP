...
public class ThreeSourceOneDestinationOperation<T1, T2, T3, R> implements Operation {
    ...
    public ThreeSourceOneDestinationOperation(
    ...
    public ThreeSourceOneDestinationOperation(
            ...
            OutputSocket.Factory outputSocketFactory,
            Performer<T1, T2, T3, R> performer,
            Class<T1> t1, Class<T2> t2, Class<T3> t3, Class<R> r) {
        this(
                inputSocketFactory,
                outputSocketFactory,
                performer,
